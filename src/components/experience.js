            ...
            <React.Fragment>
                <section id="experience" className="text-gray-600 body-font">
                    ...
                    <div className="flex flex-wrap -m-2">
                        ...
                        <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
                        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                            <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="http://midas.iiitd.edu.in/assets/themes/lab/images/logo/LOGO.png" />
                            <div className="flex-grow">
